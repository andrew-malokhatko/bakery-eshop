            ...
            <form method="GET" action="{{ route('shop') }}">
                    ...
                    <div class="filter-group">
                        ...
                        <label class="filter-option">
                            <input
                                ...
                                name="categories[]"
                                value="{{ $category->name }}"
                                @checked(in_array($category->name, $selectedCategories, true))
                            />
                    ...
                    <div class="tag-filter-group">
                        ...
                        <label class="tag-pill">
                            <input
                                ...
                                name="tags[]"
                                value="{{ $tag->name }}"
                                @checked(in_array($tag->name, $selectedTags, true))
                            />
                            <span>{{ $tag->name }}</span>
                        </label>
                        @endforeach
                ...
                <div class="filters-panel mt-2">
                    <div class="panel-actions">
                        ...
                        <button type="submit" class="panel-apply-button">Apply filters</button>
                    </div>
                </div>
            </form>
        </aside>
